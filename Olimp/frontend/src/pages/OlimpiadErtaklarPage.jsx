...
function QuizModal({ ertak, onClose, readingStats = {}, olympiadId = null, onRefresh = null }) {
    ...
    // Convert to 0-100 scale for backend
...
function DetailedQuizResultModal({ viewingResult, onClose, olympiadQuestions }) {
                    ...
                    <div className="flex justify-between items-start mb-6">
                        <div>
                            ...
                            <p className="text-white/40 text-xs uppercase tracking-widest font-bold">
                                {type === 'global' ? 'Olimpiada testi' : ertak?.title}
                            </p>
                        </div>
                                        ...
                                        <div className="flex-1">
                                            ...
                                            {question?.options ? (
                                                ...
                                                <div className="space-y-2 pt-1">
                                                   {ans.submitted_answer !== undefined && (
                                                       <p className="text-sm text-white/60">
                                                           Sizning javobingiz: <span className="text-white font-medium">{ans.submitted_answer}</span>
                                                       </p>
                                                   )}
                                                   {question?.answer && (
