...
const AdminPage = () => {
  ...
  const adminData = {
    name: "Dilshod Alimov",
    position: "Maktab ma'muri",
    school: "15-son umumiy o'rta ta'lim maktabi",
    email: "d.alimov@maktab15.uz",
    phone: "+998 71 234 56 78"
  };

  const stats = [
    { label: "Jami o'quvchilar", value: "1,247", change: "+12", trend: "up", icon: GraduationCap, color: "#8B5CF6" },
    { label: "O'qituvchilar", value: "87", change: "+3", trend: "up", icon: Users, color: "#EC4899" },
    { label: "Faol foydalanuvchilar", value: "943", change: "+156", trend: "up", icon: Activity, color: "#10B981" },
    { label: "To'lovlar (oylik)", value: "847M", change: "+8.2%", trend: "up", icon: DollarSign, color: "#F59E0B" }
  ];
  ...
  const users = [
    { id: 1, name: "Nodira Karimova", role: "O'qituvchi", email: "n.karimova@maktab15.uz", status: "active", lastLogin: "2 daqiqa oldin" },
    { id: 2, name: "Anvar Toshmatov", role: "O'quvchi", email: "a.toshmatov@maktab15.uz", status: "active", lastLogin: "5 daqiqa oldin" },
    { id: 3, name: "Dilnoza Rahimova", role: "O'quvchi", email: "d.rahimova@maktab15.uz", status: "active", lastLogin: "10 daqiqa oldin" },
    { id: 4, name: "Jamshid Toshev", role: "Moliyaviy menejer", email: "j.toshev@maktab15.uz", status: "active", lastLogin: "1 soat oldin" },
    { id: 5, name: "Malika Usmonova", role: "O'quvchi", email: "m.usmonova@maktab15.uz", status: "inactive", lastLogin: "2 kun oldin" }
  ];
  ...
  const Header = () => (
    <header className="header">
      <div className="header-left">
        ...
        <p className="header-subtitle">Administrator paneli • {new Date().toLocaleDateString('uz-UZ', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</p>
      </div>
  ...
  const UsersView = () => (
    <div className="users-view">
              ...
              <tr key={user.id}>
                ...
                <td>
                  <div className="action-buttons">
                    ...
                    <button className="icon-btn" title="O'chirish"><Trash2 size={16} /></button>
                    <button className="icon-btn" title="Bloklash"><Lock size={16} /></button>
                  </div>
                </td>
              </tr>
            ))}
      ...
      <div className="pagination">
        <button className="btn-text">Oldingi</button>
        ...
        <button className="btn-text">Keyingi</button>
      </div>
    </div>
  );
