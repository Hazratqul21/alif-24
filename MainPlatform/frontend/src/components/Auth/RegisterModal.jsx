...
© 2026 ALIF24 AI TEXNOLOGIES MCHJ. Barcha huquqlar himoyalangan.`;
  ...
  const renderFormStep = () => (
    <div className="space-y-4">
      ...
      {/* Google OAuth register — only available for adult roles (student / parent / teacher / organization) */}
      <div className="relative my-2">
        <div className="absolute inset-0 flex items-center">
          <div className="w-full border-t border-gray-200" />
        </div>
        <div className="relative flex justify-center text-xs">
          <span className="bg-white px-2 text-gray-400">yoki tezkor usul</span>
        </div>
      </div>
      <a
