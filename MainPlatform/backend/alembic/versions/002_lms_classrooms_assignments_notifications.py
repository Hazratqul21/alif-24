...
def upgrade() -> None:
    ...
    op.create_index('ix_classrooms_invite_code', 'classrooms', ['invite_code'])
    op.create_index('ix_classroom_students_classroom', 'classroom_students', ['classroom_id'])
    op.create_index('ix_classroom_students_student', 'classroom_students', ['student_user_id'])
    op.create_index('ix_assignments_created_by', 'assignments', ['created_by'])
    op.create_index('ix_assignments_classroom', 'assignments', ['classroom_id'])
    ...
    op.create_index('ix_in_app_notifications_unread', 'in_app_notifications', ['user_id', 'is_read'])
