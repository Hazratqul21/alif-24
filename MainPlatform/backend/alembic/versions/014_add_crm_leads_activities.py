...
def upgrade() -> None:
    # Use raw SQL to avoid SQLAlchemy Enum auto-creation issues
    op.execute("""
        DO $$ BEGIN
    ...
    # CRM Leads table - use String instead of sa.Enum to avoid duplicate type creation
    op.create_table(
        'crm_leads',
    ...
    op.create_table(
        ...
        sa.Column('type', sa.String(20), server_default='note'),
