    ...
    try:
        ...
        system_prompts = {
            "uz-UZ": (
                ...
                "BAHOLASH MEZONLARI:\n"
                "1. MA'NO VA MANTIQ (Eng muhimi): O'quvchi javobi namuna (correct_answer) bilan so'zma-so'z mos kelishi shart emas. Agar bola savolning mohiyatini tushungan bo'lsa va javobi ertak matniga mantiqan to'g'ri kelsa yuqori ball bering.\n"
                "2. TO'LIQLIK: Bola qanchalik to'liq javob bersa shuncha yuqori ball. Agar chala yoki noaniq javob bersa, ballni kamaytiring.\n"
                ...
                "4. BALLAR SHKALASI:\n"
                "   - 80-100 ball: Javob to'liq, aniq va savolga to'g'ri javob berilgan (hatto juda sodda tilda bo'lsa ham).\n"
                "   - 40-79 ball: Javob qisman to'g'ri, chala, yoki bola asosiy fikrni aytishga yaqin kelgan, lekin to'liq yoritmagan.\n"
                "   - 0-39 ball: Javob xato, mutlaqo savolga yoki ertakka aloqasiz (umuman boshqa narsa haqida gapirgan) yoki 'bilmayman' degan.\n\n"
            ...
            "ru-RU": (
                ...
                "КРИТЕРИИ ОЦЕНКИ:\n"
                "1. СМЫСЛ И ЛОГИКА (Самое важное): Ответ ребенка не должен дословно совпадать с образцом (correct_answer). Если ребенок понял суть вопроса и его ответ логически соответствует содержанию сказки, ставьте высокий балл.\n"
                "2. ПОЛНОТА: Чем полнее ответ, тем выше балл. Если ответ неполный или неясный, снижайте балл.\n"
                "3. ВОЗРАСТ И СТИЛЬ: Учитывайте, что это ребенок. Простой язык и короткие предложения — это нормально. Игнорируйте грамматику и ошибки STT (преобразование речи в текст).\n"
                "4. ШКАЛА БАЛЛОВ:\n"
                "   - 80-100 баллов: Ответ полный, точный и правильный (даже если на очень простом языке).\n"
                "   - 40-79 баллов: Ответ частично верный, неполный, или ребенок был близок к основной мысли, но не раскрыл ее полностью.\n"
                "   - 0-39 баллов: Ответ неверный, совершенно не относится к вопросу или сказке (говорит о другом) или сказал 'не знаю'.\n\n"
                "Ответьте в формате JSON: {\"score\": балл, \"feedback\": \"поощрительный и поясняющий комментарий\", \"passed\": true/false}"
            ),
            "en-US": (
                ...
                "EVALUATION CRITERIA:\n"
                "1. MEANING AND LOGIC (Most important): The child's answer does not have to literally match the sample (correct_answer). If the child understood the essence of the question and their answer logically matches the story content, give a high score.\n"
                "2. COMPLETENESS: The more complete the answer, the higher the score. If the answer is incomplete or vague, reduce the score.\n"
                ...
                "4. SCORING SCALE:\n"
                "   - 80-100 points: Answer is complete, accurate, and correct (even if in very simple language).\n"
                "   - 40-79 points: Answer is partially correct, incomplete, or the child was close to the main idea but didn't fully explain it.\n"
                "   - 0-39 points: Answer is incorrect, completely unrelated to the question or story (talking about something else), or they said 'I don't know'.\n\n"
                "Respond in JSON format: {\"score\": score, \"feedback\": \"encouraging and explanatory comment\", \"passed\": true/false}"
            )
        }
