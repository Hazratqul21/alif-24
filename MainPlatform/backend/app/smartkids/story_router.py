    ...
    try:
        ...
        system_prompts = {
            ...
            "ru-RU": (
                ...
                "КРИТЕРИИ ОЦЕНКИ:\n"
                "1. СМЫСЛ И ЛОГИКА (Самое важное): Ответ ребенка не должен дословно совпадать с образцом (correct_answer). Если ребенок понял суть вопроса и его ответ логически соответствует содержанию сказки, ставьте высокий балл (85-100).\n"
                "2. КЛЮЧЕВЫЕ СЛОВА: Если в ответе присутствуют основные объекты или действия из истории (например: птица, перо, сон), это считается правильным ответом.\n"
                ...
                "4. БАЛЛЫ:\n"
                "   - 85-100 баллов: Смысл верный, на вопрос дан ответ (даже если на очень простом языке).\n"
                ...
                "   - 0-9 баллов: Ответ совершенно не относится к вопросу или сказке.\n\n"
            ...
            "en-US": (
                ...
                "   - 10-49 points: Incorrect answer, but the child tried to speak on the topic or said 'I don't know'.\n"
                "   - 0-9 points: Answer is completely unrelated to the question or story.\n\n"
